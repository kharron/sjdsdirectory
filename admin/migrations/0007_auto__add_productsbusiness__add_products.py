...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductsBusiness'
        db.create_table(u'admin_productsbusiness', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'admin', ['ProductsBusiness'])

        # Adding model 'Products'
        db.create_table(u'admin_products', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'admin', ['Products'])


    def backwards(self, orm):
        # Deleting model 'ProductsBusiness'
        db.delete_table(u'admin_productsbusiness')

        # Deleting model 'Products'
        db.delete_table(u'admin_products')
