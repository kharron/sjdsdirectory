...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'admin_business', 'facebook',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Business.twitter'
        db.add_column(u'admin_business', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Business.take_credit'
        db.add_column(u'admin_business', 'take_credit',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'admin_business', 'facebook')

        # Deleting field 'Business.twitter'
        db.delete_column(u'admin_business', 'twitter')

        # Deleting field 'Business.take_credit'
        db.delete_column(u'admin_business', 'take_credit')
