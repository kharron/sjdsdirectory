...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessEspanol.facebook'
        db.add_column(u'admin_businessespanol', 'facebook',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'BusinessEspanol.twitter'
        db.add_column(u'admin_businessespanol', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessEspanol.facebook'
        db.delete_column(u'admin_businessespanol', 'facebook')

        # Deleting field 'BusinessEspanol.twitter'
        db.delete_column(u'admin_businessespanol', 'twitter')
