...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'admin_business', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default='2015-07-01 00:00:00', auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.created_at'
        db.delete_column(u'admin_business', 'created_at')
    ...
    models = {
        u'admin.business': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': "'2015-07-01 00:00:00'", 'auto_now_add': 'True', 'blank': 'True'}),
