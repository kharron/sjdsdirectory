...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessImages.position'
        db.add_column(u'admin_businessimages', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessImages.position'
        db.delete_column(u'admin_businessimages', 'position')
