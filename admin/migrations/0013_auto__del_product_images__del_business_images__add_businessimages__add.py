...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'product_images'
        db.delete_table(u'admin_product_images')

        # Deleting model 'business_images'
        db.delete_table(u'admin_business_images')

        # Adding model 'BusinessImages'
        db.create_table(u'admin_businessimages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('photo_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
        ))
        db.send_create_signal(u'admin', ['BusinessImages'])

        # Adding model 'ProductImages'
        db.create_table(u'admin_productimages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('photo_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
        ))
        db.send_create_signal(u'admin', ['ProductImages'])


    def backwards(self, orm):
        # Adding model 'product_images'
        db.create_table(u'admin_product_images', (
            ('photo_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'admin', ['product_images'])

        # Adding model 'business_images'
        db.create_table(u'admin_business_images', (
            ('photo_name', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'admin', ['business_images'])

        # Deleting model 'BusinessImages'
        db.delete_table(u'admin_businessimages')

        # Deleting model 'ProductImages'
        db.delete_table(u'admin_productimages')
