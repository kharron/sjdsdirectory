...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessEspanol.products'
        db.add_column(u'admin_businessespanol', 'products',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessEspanol.products'
        db.delete_column(u'admin_businessespanol', 'products')
