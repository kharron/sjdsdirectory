...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchKeywords'
        db.create_table(u'admin_searchkeywords', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keyword_phrase', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'admin', ['SearchKeywords'])


    def backwards(self, orm):
        # Deleting model 'SearchKeywords'
        db.delete_table(u'admin_searchkeywords')
