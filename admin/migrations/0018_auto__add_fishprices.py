...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FishPrices'
        db.create_table(u'admin_fishprices', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fishname_english', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('fishname_spanish', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('fish_description', self.gf('django.db.models.fields.CharField')(max_length=254, blank=True)),
            ('price', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('fish_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'admin', ['FishPrices'])


    def backwards(self, orm):
        # Deleting model 'FishPrices'
        db.delete_table(u'admin_fishprices')
