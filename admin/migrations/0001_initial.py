...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'admin', ['Users'])

        # Adding model 'Categories'
        db.create_table(u'admin_categories', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'admin', ['Categories'])

        # Adding model 'Business'
        db.create_table(u'admin_business', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ...
        db.send_create_signal(u'admin', ['Business'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'admin_users')

        # Deleting model 'Categories'
        db.delete_table(u'admin_categories')

        # Deleting model 'Business'
        db.delete_table(u'admin_business')
