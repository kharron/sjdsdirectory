...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategoriesBusiness'
        db.create_table(u'admin_categoriesbusiness', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('business_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'admin', ['CategoriesBusiness'])

        # Deleting field 'Categories.business_id'
        db.delete_column(u'admin_categories', 'business_id')

        # Adding field 'Categories.desc'
        db.add_column(u'admin_categories', 'desc',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CategoriesBusiness'
        db.delete_table(u'admin_categoriesbusiness')

        # Adding field 'Categories.business_id'
        db.add_column(u'admin_categories', 'business_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Categories.desc'
        db.delete_column(u'admin_categories', 'desc')
